...
Steps preceding use of this package:
  1. Run Tandem Repeats Finder https://tandem.bu.edu/trf/trf.html to identify
     input sequences.
...
This data is accompanied by several accessory datasets specific for a VNTR in CACNA1C.
...
All data.frames used in this repository have an example in data/ directory.

## Citation

R. Moya, X. Wang, R. W. Tsien, M. T. Maurano, Structure of a polymorphic repeat at the CACNA1C schizophrenia locus. PNAS (2025). Available at: https://doi.org/10.1073/pnas.241565012
...
Example visualization of a multiple sequence alignment. Each color is a unique repeat unit. Alignment gaps are shown in black.

```{r plot_msa_example, echo = FALSE, warning=FALSE}
